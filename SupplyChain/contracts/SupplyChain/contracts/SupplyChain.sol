...
contract SupplyChain is Users, Products {
    ...
    modifier onlyRole(Types.UserRole role_) {
        require(user[msg.sender].role == role_, "Unauthorized");
        _;
    }
    ...
    //function productOwnerHistory(string memory productId) public view returns (address[] memory) {
    //    return getProductOwnerHistory[productId];
    //}
